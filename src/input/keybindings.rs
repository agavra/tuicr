...
fn map_normal_mode(key: KeyEvent, leader_key: char) -> Action {
    match (key.code, key.modifiers) {
        ...
        (KeyCode::Char('v'), KeyModifiers::CONTROL) => Action::PageDown,
        (KeyCode::Char('v'), KeyModifiers::ALT) => Action::PageUp,
...
fn map_submit_resolver_mode(key: KeyEvent) -> Action {
    match (key.code, key.modifiers) {
        ...
        (KeyCode::Char('n'), KeyModifiers::CONTROL) => Action::SubmitResolverDown,
        (KeyCode::Char('p'), KeyModifiers::CONTROL) => Action::SubmitResolverUp,
...
fn map_submit_action_picker_mode(key: KeyEvent) -> Action {
    match (key.code, key.modifiers) {
        ...
        (KeyCode::Char('n'), KeyModifiers::CONTROL) => Action::SubmitPickerDown,
        (KeyCode::Char('p'), KeyModifiers::CONTROL) => Action::SubmitPickerUp,
...
fn map_commit_select_mode(key: KeyEvent) -> Action {
    match (key.code, key.modifiers) {
        ...
        (KeyCode::Char('n'), KeyModifiers::CONTROL) => Action::CommitSelectDown,
        (KeyCode::Char('p'), KeyModifiers::CONTROL) => Action::CommitSelectUp,
...
fn map_visual_mode(key: KeyEvent) -> Action {
    match (key.code, key.modifiers) {
        ...
        (KeyCode::Char('y'), KeyModifiers::NONE) => Action::ExportToClipboard,
        (KeyCode::Esc, KeyModifiers::NONE) => Action::ExitMode,
        (KeyCode::Char('g'), KeyModifiers::CONTROL) => Action::ExitMode,
